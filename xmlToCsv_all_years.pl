...
#
open ITEMTOBIB, '>:utf8', "itemToBib.csv" or die $!;
open TRANSACTIONS, '>:utf8', "transactions.csv" or die $!;
open COLLECTIONCODE, '>:utf8', "collectionCode.csv" or die $!;
open ITEMTYPE, '>:utf8', "itemType.csv" or die $!;
open ITEMTOBARCODE, '>:utf8', "itemToBarcode.csv" or die $!;
open TITLE, '>:utf8', "title.csv" or die $!;
open CALLNUMBER, '>:utf8', "callNumber.csv" or die $!;
open DEWEYCLASS, '>:utf8', "deweyClass.csv" or die $!;
open SUBJECT, '>:utf8', "subject.csv" or die $!;
...
for my $inOut ('out', 'in') {
  ...
  #
  if ($inOut eq 'in') {
    open MAINOUTPUT, '>:utf8', "inraw.csv" or die $!;
  } else {
    open MAINOUTPUT, '>:utf8', "outraw.csv" or die $!;
  }
