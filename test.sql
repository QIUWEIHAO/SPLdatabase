...
select itemNumber,collectionCode from outraw where (itemNumber,collectionCode) not in (select itemNumber,collectionCode from collectionCode);
select itemNumber,collectionCode from inraw where (itemNumber,collectionCode) not in (select itemNumber,collectionCode from collectionCode);
